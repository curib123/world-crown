# WORLD CROWN Repository Rules

## Authority order
1. `01_CANON/MASTER_CANON.md`
2. `01_CANON/NARRATIVE_STRUCTURE.md`
3. `01_CANON/CHAPTER_AND_BATTLE_CONTINUITY_RULES.md`
4. `01_CANON/SOUL_DRIFT_RULES.md`
5. `01_CANON/HOST_SYNC_RULES.md`
6. `04_POWER_SYSTEMS/MASTER_POWER_SYSTEM.md`
7. `05_TOURNAMENT/FORMAT_AND_PACING.md`
8. `08_PLANNING/SERIES_SAGA_OUTLINE.md`
9. `00_PROJECT/WRITING_RULE.md`
10. champion- and match-specific files
11. draft prose

## Hard rules
- Do not import story canon from `Survive-as-reincarnated-bat-`.
- No single permanent main character or hero nation.
- Core protagonists may lose, die, be eliminated, or lose their homeland.
...
- The tournament tone is fast, mythic, ceremonial, and dangerous; setup, commentary, recovery, and exposition must create pressure or consequence rather than delay the next meaningful choice or clash.
- Soul Drift means two souls and two personalities share one living host body: the historical champion and the modern host remain separate people with agency.
